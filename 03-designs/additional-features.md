# Additional Desirable Features at Additional Cost to Purchasers

This section outlines premium features beyond the base smart home specification that could be offered to purchasers at additional cost. These range from practical upgrades to emerging technologies.
...
- **Benefit:** Potential 70–80% reduction in grid electricity costs; provides backup power during outages

---

## Tier 2: Robotic Workforce (Emerging Technology)

These features represent the cutting edge of smart home automation. While not included in the base specification due to their emerging nature and premium pricing, they demonstrate the future direction of domestic technology and could be offered as high-end upgrades.

### 2.1 Humanoid Domestic Assistant — 1X Neo
...
- Operating noise: **22dB** (whisper-quiet)
- Built-in **LLM (Large Language Model)** for natural language understanding and autonomous task prioritisation
- **Tele-Operation "Expert Mode":** Remote professional can pilot the robot via VR for complex tasks, simultaneously training the local AI model

**Pricing:** ~£20,000 per unit
**Requires:** Dedicated 6-minute quick-charge station per unit (1 hour runtime per charge)
**Best suited for:** 4-bedroom family homes (domestic tasks); sheltered accommodation (supervised care support)
...
- **Pricing:** Emerging technology; estimated £8,000–£15,000 per unit
...
- **Pricing:** ~£4,500 per unit
- **Benefit:** Clinically proven to reduce agitation and improve mood in dementia patients (Wada & Shibata, 2007; multiple subsequent trials)
...
- **Pricing:** from £248,000 (full system with arms); ~£128,000–£140,000 (base IoT kitchen without arms)
- **Best suited for:** Premium communal kitchen in sheltered accommodation where residents should not use conventional hobs/ovens due to cognitive impairment or fire risk
- **Note:** At this price point, this is aspirational and would need to be justified by a care-needs assessment. The Thermomix TM7 (£1,349, included in our base sheltered specification) provides 80% of the safety benefit at less than 1% of the cost.
...
- **Pricing:** ~£4,500–£6,500 per unit (communal estate mower)
...
- **Pricing:** ~£499
- **Benefit:** Eliminates need for external window cleaning services; particularly valuable for hard-to-reach windows on upper floors
...
- **Pricing:** ~£15,000 per installation
...
- **Benefit:** Accessibility (BS 8300 compliance in sheltered accommodation); space optimisation in starter homes

---

## Desirable Features Cost Summary

| Feature | Applicable Homes | Cost per Unit (GBP) |
|---|---|---|
| Sonos whole-home audio (4 rooms) | Family | £796 |
| Smart garden irrigation | Family | ~£159 |
| Ring Protect Pro monitoring | All | £96/year |
| Tesla Powerwall 3 | Family | ~£6,500 |
| 1X Neo humanoid assistant | Family / Sheltered | ~£20,000 |
| ElliQ 3.0 companion robot | Sheltered | ~£6,000 |
| PARO therapeutic seal | Sheltered (dementia) | ~£4,500 |
| Moley Robotic Kitchen | Sheltered (communal) | from £128,000 |
| Husqvarna Ceora robotic mower | Estate (communal) | ~£4,500–£6,500 |
| Ecovacs Winbot W2 Omni | All | ~£499 |
| Ori Living robotic furniture | Starter | ~£15,000 |
| Vertical storage carousel | Starter / Sheltered | ~£3,000–£5,000 |

---

## Note on Emerging Technology

The robotic technologies listed in Tier 2 represent the trajectory of smart home evolution. While the base specifications in this report use established, commercially available products with proven UK market availability and verifiable pricing, these emerging technologies illustrate the potential for future upgrades as costs decrease and technology matures. The architectural firm may wish to ensure that structural provisions (reinforced ceiling mounts for Moley, charging station power points for humanoids, cable routing for robotic furniture tracks) are incorporated at build stage to enable future retrofit at reduced cost.
